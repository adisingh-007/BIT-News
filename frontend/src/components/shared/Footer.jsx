    ...
    <div className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm">
            814142 BIT Deoghar, Jharkhand, India
          </p>

          <p className="text-gray-400 text-sm">Email: adisingh1040@gmail.com</p>

          <p className="text-gray-400 text-sm">Phone: +6205474281</p>
        </div>
      </div>
