  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok || data.success === false) {
        toast({ title: data.message || "Update user failed. Please try again!" })
        ...
        // Clear local image state after successful update
        setImageFile(null)
    ...
    <div className="max-w-lg mx-auto p-3 w-full">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <div className="w-32 h-32 self-center cursor-pointer overflow-hidden">
          <img
            key={currentUser.profilePicture} // Force re-render when profile picture changes
